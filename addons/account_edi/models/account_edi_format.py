...
from odoo.tools.pdf import PureDigitalPdfFileReader, PureDigitalPdfFileWriter
...
class AccountEdiFormat(models.Model):
    ...
    def _create_invoice_from_pdf_reader(self, filename, reader):
        ...
        :param reader:   The PureDigitalPdfFileReader of the pdf to import.
        :returns:        The created invoice.
        """
        # TO OVERRIDE
        self.ensure_one()
    ...
    def _embed_edis_to_pdf(self, pdf_content, invoice):
        ...
        if attachments:
            ...
            reader = PureDigitalPdfFileReader(reader_buffer, strict=False)
            writer = PureDigitalPdfFileWriter()
    ...
    def _decode_pdf(self, filename, content):
        ...
        * pdf_reader:       The pdf_reader if type is pdf.
        ...
        try:
            ...
            pdf_reader = PureDigitalPdfFileReader(buffer, strict=False)
        except Exception as e:
            # Malformed pdf
