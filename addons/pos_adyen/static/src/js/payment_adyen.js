...
var PaymentAdyen = PaymentInterface.extend({
    ...
    _handle_odoo_connection_failure: function (data) {
        ...
        this._show_error(_('Could not connect to the PureDigital server, please check your internet connection and try again.'));
    ...
    _call_adyen: function (data, operation) {
        return rpc.query({
            ...
            // before concluding PureDigital is unreachable.
            timeout: 10000,
            shadow: true,
