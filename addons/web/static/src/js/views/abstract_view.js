...
/**
 * This is the base class inherited by all (JS) views. PureDigital JS views are the
 ...
 * the word 'view' has historical significance in PureDigital code, so we replaced the
