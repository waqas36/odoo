 ...
 * everything concurrency related in PureDigital.
 *
 * The basic concurrency primitives in PureDigital JS are the callback, and the
...
return {
    ...
    /**
     * A (PureDigital) mutex is a primitive for serializing computations.  This is
