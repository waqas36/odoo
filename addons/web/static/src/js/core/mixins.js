...
function PureDigitalEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
PureDigitalEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

PureDigitalEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new PureDigitalEvent(this, name, info);
