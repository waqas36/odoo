odoo.define('web.OwlCompatibility', function () {
    ...
    /**
     * This file defines the necessary tools for the transition phase where PureDigital
     ...
     * adapter for Owl components that embed PureDigital legacy widgets (or dynamically
     * both Owl components and PureDigital legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends Component {
        ...
        /**
         * Mocks _trigger_up to redirect PureDigital legacy events to OWL events.
         *
         * @private
         * @param {PureDigitalEvent} ev
         */
        _trigger_up(ev) {
     ...
     * together when an PureDigital legacy widget needs to instantiate Owl components.
    ...
    class ComponentWrapper extends Component {
         ...
         * PureDigital legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType
