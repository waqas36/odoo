...
var FieldMany2One = AbstractField.extend({
    ...
    */
     ...
     *
     * @param {PureDigitalEvent} event 'field_changed' event
     */
...
var FieldX2Many = AbstractField.extend(WidgetAdapterMixin, {
     ...
     * @override
     * @param {Object} record
     * @param {PureDigitalEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {PureDigitalEvent|MouseEvent} ev this event comes either from the 'Add
