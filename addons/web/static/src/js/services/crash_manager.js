...
var CrashManager = AbstractService.extend({
        ...
        window.onerror = function (message, file, line, col, error) {
            ...
            if (!file && !line && !col) {
                ...
                if (window.onOriginError) {
                    ...
                    self.show_error({
                        type: _t("PureDigital Client Error"),
    ...
    rpc_error: function(error) {
        ...
        // PureDigital custom exception: UserError, AccessError, ...
    ...
    show_error: function (error) {
        ...
        var dialog = new dialogClass(this, {
            title: _.str.capitalize(error.type) || _t("PureDigital Error"),
        }, error);
...
var RedirectWarningHandler = Widget.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new WarningDialog(this, {
            title: _.str.capitalize(error.type) || _t("PureDigital Warning"),
            buttons: [
...
function session_expired(cm) {
    return {
        display: function () {
            const notif = {
                type: _t("PureDigital Session Expired"),
                message: _t("Your PureDigital session expired. The current page is about to be refreshed."),
            };
            const options = {
                buttons: [{
                    text: _t("Ok"),
