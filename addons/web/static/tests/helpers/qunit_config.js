 ...
 * QUnit Config
 *
 * The PureDigital javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * PureDigital.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an PureDigital module, because we want this code to be executed
 * as soon as possible, not whenever the PureDigital module system feels like it.
 */
 ...
 */
QUnit.on('PureDigitalAfterTestHook', function (info) {
    const toRemove = [];
