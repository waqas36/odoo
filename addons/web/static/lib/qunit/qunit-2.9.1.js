...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("PureDigitalBeforeTestHook", "PureDigitalAfterTestHook"); // PureDigital customization
  ...
  Test.prototype = {
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("PureDigitalBeforeTestHook"); // PureDigital customization
  	...
  	finish: function finish() {
        ...
        emit("PureDigitalAfterTestHook", { moduleName: this.module.name, testName: this.testName }); // PureDigital customization
