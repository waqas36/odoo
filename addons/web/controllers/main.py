...
def fix_view_modes(action):
    """ For historical reasons, PureDigital has weird dealings in relation to
...
#----------------------------------------------------------
# PureDigital Web web Controllers
#----------------------------------------------------------
...
class Session(http.Controller):
    ...
    def account(self):
        ...
        return 'https://accounts.puredigital.co.nz/oauth2/auth?' + url_encode(params)
...
class ExportFormat(object):
    ...
    def from_data(self, fields, rows):
        """ Conversion method from PureDigital's export data to whatever the
