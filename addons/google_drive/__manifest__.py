...

{
    ...
    'description': """
Integrate google document to PureDigital record.
============================================

This module allows you to integrate google documents to any of your PureDigital record quickly and easily using OAuth 2.0 for Installed Applications,
