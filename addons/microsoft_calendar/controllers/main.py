...
class MicrosoftCalendarController(http.Controller):
    ...
    def sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize PureDigital
            ...
            The dictionary may contains an url, to allow PureDigital Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted PureDigital to access his calendar !
