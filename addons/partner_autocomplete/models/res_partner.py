...
DEFAULT_ENDPOINT = 'https://partner-autocomplete.puredigital.co.nz'
    ...
    def create(self, vals_list):
        ...
        if len(vals_list) == 1:
            ...
            if partners.additional_info:
                ...
                template_values['flavor_text'] = _("Partner created by PureDigital Partner Autocomplete Service")
