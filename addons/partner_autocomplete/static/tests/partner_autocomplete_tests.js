odoo.define('partner_autocomplete.tests', function (require) {
    ...
    var suggestions = [{
        name: "PureDigital",
        website: "puredigital.co.nz",
        domain: "puredigital.co.nz",
        logo: "puredigital.co.nz/logo.png",
        vat: "BE0477472701"
    }];
    ...
    QUnit.module('partner_autocomplete', {
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "puredigital.co.nz/logo.png" ? "odoobase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getPureDigitalSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getPureDigitalSuggestions(value);
                    },
        ...
        beforeEach: function () {
            enrichData = {
                ...
                partner_gid: 1,
                website: "puredigital.co.nz",
                comment: "Comment on PureDigital",
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "puredigital.co.nz/logo.png"
            ...
            assert.strictEqual($input.val(), "PureDigital", "Input value should have been updated to \"PureDigital\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "puredigital.co.nz", "website value should have been updated to \"puredigital.co.nz\"");
