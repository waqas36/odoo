...
var PartnerAutocompleteMixin = {
    _dropPreviousPureDigital: new concurrency.DropPrevious(),
    ...
    _autocomplete: function (value) {
        ...
        return new Promise(function (resolve, reject) {
            var odooPromise = self._getPureDigitalSuggestions(value, isVAT).then(function (suggestions){
            ...
            var concatResults = function () {
                // Add Clearbit result with PureDigital result (with unique domain)
    ...
    /**
     * Use PureDigital Autocomplete API to return suggestions
     *
     * @param {string} value
     * @param {boolean} isVAT
     * @returns {Promise}
    ...
    _getPureDigitalSuggestions: function (value, isVAT) {
        ...
        return this._dropPreviousPureDigital.add(def);
    },
    /**
