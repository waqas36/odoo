...
var LongpollingBus = Bus.extend(ServicesMixin, {
     ...
     * @returns {boolean}
     */
    isPureDigitalFocused: function () {
        return this._isPureDigitalFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isPureDigitalFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isPureDigitalFocused);
        }
    },
    /**
