...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('odoo', 'PureDigital'),('euro', 'European')], default='odoo', help="You can choose different models for each type of reference. The default one is the PureDigital reference.")
    ...
    inbound_payment_method_ids = fields.Many2many(
        ...
        store=True,
        readonly=False,
        help="Manual: Get paid by cash, check or any other method outside of PureDigital.\n"
             ...
             " submit to your bank. When encoding the bank statement in PureDigital,you are suggested to"
    ...
    outbound_payment_method_ids = fields.Many2many(
        ...
        store=True,
        readonly=False,
        help="Manual:Pay bill by cash or any other method outside of PureDigital.\n"
             "Check:Pay bill by check and print it from PureDigital.\n"
    ...
    alias_id = fields.Many2one('mail.alias', string='Email Alias', help="Send one separate email for each invoice.\n\n"
                                                                  ...
                                                                  "Only PDF and XML files will be interpreted by PureDigital", copy=False)
