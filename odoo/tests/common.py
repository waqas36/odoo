...
def standalone(*tags):
    ...
    ``tags`` and the corresponding PureDigital module name.
    """
    def register(func):
...
# Main classes
# ------------------------------------------------------------
class PureDigitalSuite(unittest.suite.TestSuite):
...
class BaseCase(TreeCase, MetaCase('DummyCase', (object,), {})):
    ...
    longMessage = True      # more verbose error message by default: https://www.puredigital.co.nz/r/Vmh
...
class ChromeBrowser():
    ...
    def _from_remoteobject(self, arg):
        ...
        # of the way PureDigital widgets are created they all appear as Class(...)
