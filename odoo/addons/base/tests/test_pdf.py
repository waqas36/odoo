...
class TestPdf(TransactionCase):
    ...
    def setUp(self):
        ...
        self.minimal_pdf_reader = pdf.PureDigitalPdfFileReader(self.minimal_reader_buffer)
    ...
    def test_odoo_pdf_file_writer(self):
        ...
        pdf_writer = pdf.PureDigitalPdfFileWriter()
        pdf_writer.cloneReaderDocumentRoot(self.minimal_pdf_reader)
    ...
    def test_merge_pdf(self):
        ...
        merged_pdf_reader = pdf.PureDigitalPdfFileReader(merged_reader_buffer)
    ...
    def test_branded_file_writer(self):
        ...
        self.assertEqual(pdf_info['/Producer'], 'PureDigital')
        self.assertEqual(pdf_info['/Creator'], 'PureDigital')
        reader_buffer.close()
