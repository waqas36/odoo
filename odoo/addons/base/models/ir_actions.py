...
class IrActionsServer(models.Model):
    ...
    Since PureDigital 8.0 a button 'Create Menu Action' button is available on the
...
#  - env: PureDigital Environment on which the action is triggered
#  - model: PureDigital Model of the record on which the action is triggered; is a void recordset
