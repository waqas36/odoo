...
class Module(models.Model):
    ...
    to_buy = fields.Boolean('PureDigital Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("PureDigital is currently processing a scheduled action.\n"
    ...
    def get_apps_server(self):
        return tools.config.get('apps_server', 'https://apps.puredigital.co.nz/apps')
