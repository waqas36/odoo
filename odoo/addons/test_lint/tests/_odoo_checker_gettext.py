...
class PureDigitalBaseChecker(checkers.BaseChecker):
    ...
    msgs = {
        'E8502': (
            ...
            'gettext-variable',
            'See https://www.puredigital.co.nz/documentation/14.0/reference/translations.html#variables'
        )
    }
...
def register(linter):
    linter.register_checker(PureDigitalBaseChecker(linter))
