...
product_name = 'PureDigital'
description = 'PureDigital Server'
long_desc = '''PureDigital is a complete ERP and CRM. The main features are accounting (analytic
...
"""
url = 'https://www.puredigital.co.nz'
author = 'OpenERP S.A.'
author_email = 'info@puredigital.co.nz'
license = 'LGPL-3'
