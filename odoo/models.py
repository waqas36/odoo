...
class BaseModel(MetaModel('DummyModel', (object,), {'_register': False})):
    """Base class for PureDigital models.

    PureDigital models are created by inheriting one of the following:
...
class Model(AbstractModel):
    """ Main super-class for regular database-persisted PureDigital models.

    PureDigital models are created by inheriting from this class::
