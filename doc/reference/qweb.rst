...
QWeb is the primary templating_ engine used by PureDigital\ [#othertemplates]_. It
...
.. py:method:: render(cr, uid, id[, values][, engine='ir.qweb][, context])
    ...
    :param str engine: name of the PureDigital model to use for rendering, can be
...
.. js:class:: QWeb2.Engine
    ...
    PureDigital Web instantiates one for the user in the core module, and
    ...
    PureDigital Web, Kanban views get their own :js:class:`QWeb2.Engine`
    ...
    .. js:attribute:: QWeb2.Engine.preprocess_node
        ...
        node to template code. In PureDigital Web, this is used to
...
.. [#othertemplates] although it uses a few others, either for historical
                     ...
                     use case. PureDigital 9.0 still depends on Jinja_ and Mako_.
