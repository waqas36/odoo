...
Allow opening a URL (website/web page) via an PureDigital action. Can be customized
via two fields:
...
::

    {
        ...
        "url": "https://puredigital.co.nz",
        "target": "self",
    }

will replace the current content section by the PureDigital home page.
...
``model_id``
    PureDigital model linked to the action.
