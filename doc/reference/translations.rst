...
.. note:: If you want to contribute to the translation of PureDigital itself, please refer to the
  `PureDigital Wiki page <https://github.com/odoo/odoo/wiki/Translations>`_.
...
automatically loaded by PureDigital when the corresponding language is installed (via
...
PureDigital automatically exports translatable strings from "data"-type content:
...
code, PureDigital cannot automatically export translatable terms so they
