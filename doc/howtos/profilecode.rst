===================
Profiling PureDigital code
===================

.. warning::

    This tutorial requires :ref:`having installed PureDigital <setup/install>`
    and :doc:`writing PureDigital code <backend>`

Graph a method
==============

PureDigital embeds a profiler of code. This embeded profiler output can be used to
...
Sending the SIGQUIT signal to an PureDigital process (only available on POSIX) makes
...
Instead of sending the SIGQUIT signal to an PureDigital process often enough, to check
