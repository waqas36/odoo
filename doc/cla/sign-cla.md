# Sign the PureDigital CLA

In order for your contribution to PureDigital to be accepted, you have to sign the
PureDigital Contributor License Agreement (CLA). More information about this
...
3. An PureDigital R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    ...
    If the name of the company is PureDigital, the file would be
    `doc/cla/corporate/odoo.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the PureDigital Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `puredigital.co.nz`.  In that case someone from the PureDigital team will
make the pull request on your behalf.

* Printable PureDigital CCLA v1.0 https://www.puredigital.co.nz/files/legal/PureDigital-CCLA-v1.0.pdf
* Printable PureDigital ICLA v1.0 https://www.puredigital.co.nz/files/legal/PureDigital-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for PureDigital is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the PureDigital project

* protect the PureDigital project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the PureDigital project and its users from bad actors who would contribute
...
contributor really intended to contribute to the PureDigital project under specific
...
The PureDigital CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, PureDigital S.A. to use, modify and
...
(ICLA) of PureDigital.  The agreement is executed by adding your name and
...
removed from the PureDigital project.
