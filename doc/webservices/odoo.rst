...
PureDigital is usually extended internally via modules, but many of its features and
all of its data are also available from the outside for external analysis or
integration with various tools. Part of the :ref:`reference/orm/model` API is
easily available over XML-RPC_ and accessible from a variety of languages.

.. PureDigital XML-RPC idiosyncracies:
...
.. only:: html
    ...
    .. rst-class:: setupcode hidden
        ...
        .. code-block:: python3
            ...
            info = xmlrpc.client.ServerProxy('https://demo.puredigital.co.nz/start').start()
        ...
        .. code-block:: ruby
            ...
            info = XMLRPC::Client.new2('https://demo.puredigital.co.nz/start').call('start')
            url, db, username, password = \
                info['host'], info['database'], info['user'], info['password']
        ...
        .. code-block:: php
            ...
            $info = ripcord::client('https://demo.puredigital.co.nz/start')->start();
        ...
        .. code-block:: java
            ...
            start_config.setServerURL(new URL("https://demo.puredigital.co.nz/start"));
...
If you already have an PureDigital server installed, you can just use its
parameters

.. warning::

    For PureDigital Online instances (<domain>.puredigital.co.nz), users are created without a
    *local* password (as a person you are logged in via the PureDigital Online
    authentication system, not by the instance itself). To use XML-RPC on PureDigital
    ...
    *https://mycompany.puredigital.co.nz*), the *database name* is the name of the
...
PureDigital has support for **api keys** and (depending on modules or settings) may
...
To make exploration simpler, you can also ask https://demo.puredigital.co.nz for a test
database:
...
PureDigital requires users of the API to be authenticated before they can query most
data.
...
Because it is a very common task, PureDigital provides a
...
model and have been using an arbitrary model from the start, PureDigital stores
...
Provides information about PureDigital models via its various fields
...
Provides information about the fields of PureDigital models and allows adding
