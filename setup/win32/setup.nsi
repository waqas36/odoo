...
!define PUBLISHER 'PureDigital S.A.'
...
!define PRODUCT_NAME "PureDigital"
...
!define UNINSTALL_REGISTRY_KEY_SERVER "${UNINSTALL_BASE_REGISTRY_KEY}\PureDigital Server ${VERSION}"
...
!define MUI_FINISHPAGE_LINK_LOCATION "https://www.puredigital.co.nz/page/contactus"
...
; English
LangString DESC_PureDigital_Server ${LANG_ENGLISH} "Install the PureDigital Server with all the PureDigital standard modules."
LangString DESC_PostgreSQL ${LANG_ENGLISH} "Install the PostgreSQL RDBMS used by PureDigital."
LangString DESC_FinishPage_Link ${LANG_ENGLISH} "Contact PureDigital for Partnership and/or Support"
LangString DESC_AtLeastOneComponent ${LANG_ENGLISH} "You have to choose at least one component"
LangString DESC_CanNotInstallPostgreSQL ${LANG_ENGLISH} "You can not install the PostgreSQL database without the PureDigital Server"
...
LangString TITLE_PureDigital_Server ${LANG_ENGLISH} "PureDigital Server"
LangString TITLE_PostgreSQL ${LANG_ENGLISH} "PostgreSQL Database"
LangString DESC_FinishPageText ${LANG_ENGLISH} "Start PureDigital"

; French
LangString DESC_PureDigital_Server ${LANG_FRENCH} "Installation du Serveur PureDigital avec tous les modules PureDigital standards."
LangString DESC_PostgreSQL ${LANG_FRENCH} "Installation de la base de données PostgreSQL utilisée par PureDigital."
LangString DESC_FinishPage_Link ${LANG_FRENCH} "Contactez PureDigital pour un Partenariat et/ou du Support"
LangString DESC_AtLeastOneComponent ${LANG_FRENCH} "Vous devez choisir au moins un composant"
LangString DESC_CanNotInstallPostgreSQL ${LANG_FRENCH} "Vous ne pouvez pas installer la base de données PostgreSQL sans le serveur PureDigital"
...
LangString TITLE_PureDigital_Server ${LANG_FRENCH} "Serveur PureDigital"
LangString TITLE_PostgreSQL ${LANG_FRENCH} "Installation du serveur de base de données PostgreSQL"
LangString DESC_FinishPageText ${LANG_FRENCH} "Démarrer PureDigital"

InstType $(Profile_AllInOne)
InstType $(Profile_Server)

Section $(TITLE_PureDigital_Server) SectionPureDigital_Server
    SectionIn 1 2
    ...
    # If there is a previous install of the PureDigital Server, keep the login/password from the config file
...
Section $(TITLE_PostgreSQL) SectionPostgreSQL
    ...
    ExecWait '"$TEMP\$postgresql_exe_filename" \
        ...
        --servicename "PostgreSQL_For_PureDigital" \
...
Section -Post
    ...
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpLink" "support@puredigital.co.nz"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpTelephone" "+32.81.81.37.00"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "URLInfoAbout" "https://www.puredigital.co.nz"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "Contact" "sales@puredigital.co.nz"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
    !insertmacro MUI_DESCRIPTION_TEXT ${SectionPureDigital_Server} $(DESC_PureDigital_Server)
...
Function .onInit
    ...
    ${If} $previous_install_dir == ""
        ${If} ${RunningX64}
            StrCpy $INSTDIR "$PROGRAMFILES64\PureDigital ${VERSION}"
        ${Else}
            StrCpy $INSTDIR "$PROGRAMFILES\PureDigital ${VERSION}"
        ${EndIf}
...
Function ShowPostgreSQL
    SectionGetFlags ${SectionPureDigital_Server} $0
